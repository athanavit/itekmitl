...
<head>
    ...
    <title>ระบบรายวิชา | ITE - KMITL</title>
    <!-- for chrome mobile -->
...
<body>
        ...
        <div class="collapse navbar-collapse" style="margin-top: 4px;" id="navbarSupportedContent">
            ...
            <?php
                ...
                <div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"accountDropdownMenuLink\">
                    ...
                    <a class=\"dropdown-item\" href=\"../landing.php\">ระบบอาจารย์</a></a>
                    <div class=\"dropdown-divider\"></div>
    ...
    <main id="main" style="margin-top: 73px; padding: 20px 5%;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <button class="btn btn-primary" style="margin-bottom: 10px;">สร้างวิชาใหม่</button>
                </div>
                <div class="col-sm-12">
                    <div class="card" style="padding: 10px; margin-bottom: 10px;">
                        <div class="card-body">
                            <h5 class="card-title">Subject 1</h5>
                            <p class="card-text">0123XXXX Teach by P.XXX XXXXX</p>
